...
Java.performNow(function() {
    ...
    // Java.choose("com.android.baselib.util.AESImpl", {
...
let a = Java.use("z8.a");
a["c"].implementation = function (str) {
    console.log(`a.c is called: str=${str}`);
    let result = this["c"](str);
    console.log(`a.c result=${result}`);
    return result;
};
a["d"].implementation = function (str) {
    console.log(`a.d is called: str=${str}`);
...
//     //com.heat.novelpro.Config
//     //com.android.baselib.util.AESImpl
// let AESImpl = Java.use("com.android.baselib.util.AESImpl");
// AESImpl["encode"].implementation = function (str) {
//     console.log('encode is called' + ', ' + 'str: ' + str);
//     let ret = this.encode(str);
//     console.log('encode ret value is ' + ret);
//     return ret;
// };
// AESImpl["decode"].implementation = function (str) {
//     console.log('decode is called' + ', ' + 'str: ' + str);
//     let ret = this.decode(str);
//     console.log('decode ret value is ' + ret);
//     return ret;
// };
//
// let MD5 = Java.use("com.android.baselib.util.MD5");
// MD5["string2MD5"].implementation = function (str) {
//     console.log('string2MD5 is called' + ', ' + 'str: ' + str);
//     let ret = this.string2MD5(str);
//     console.log('string2MD5 ret value is ' + ret);
//     return ret;
// };
//
//
// // let SecretKeySpec = Java.use("javax.crypto.spec.SecretKeySpec");
// // SecretKeySpec["$init"].overload('[B', 'java.lang.String').implementation = function (apiManager) {
// //     console.log('$init is called' + ', ' + 'SecretKeySpec: ' + apiManager);
// //     let ret = this.$new(apiManager);
