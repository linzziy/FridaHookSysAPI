...
let k = Java.use("com.novel.romance.free.net.k");
k["e"].implementation = function (str, str2, lVar) {
    console.log('e is called' + ', ' + 'str: ' + str + ', ' + 'str2: ' + str2 + ', ' + 'lVar: ' + lVar);
    showStacks()
    let ret = this.e(str, str2, lVar);
    console.log('e ret value is ' + ret);
    return ret;
};
let g = Java.use("io.reactivex.g");
g["a"].implementation = function (lVar) {
    console.log('a is called' + ', ' + 'lVar: ' + lVar);
    let ret = this.a(lVar);
