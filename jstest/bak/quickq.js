...
// let i = Java.use("r0.c$i");
// i["success"].implementation = function (obj) {
//     console.log('success is called' + ', ' + 'obj: ' + obj);
//     let ret = this.success(obj);
//     console.log('success ret value is ' + ret);
//     return ret;
// };
// let a = Java.use("r0.c$i$a");
// a["$init"].implementation = function (obj) {
//     console.log('$init is called' + ', ' + 'obj: ' + obj);
//     printFields(obj)
//     let ret = this.$new(obj);
//     printFields('$init ret value is ' + ret);
//     showStacks(ret)
//     return ret;
// };
// console.log('0000')

let MainActivity = Java.use("net.s17s.s17ray.MainActivity");
MainActivity["onMethodCall"].implementation = function (methodCall, result) {
    console.log('onMethodCall is called' + ', ' + 'methodCall: ' + methodCall + ', ' + 'result: ' + result);
    let ret = this.onMethodCall(methodCall, result);
    console.log('onMethodCall ret value is ' + ret);
    return ret;
};
