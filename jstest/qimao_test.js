...
Java.performNow(function() {
    // // //let AESImpl = Java.use("com.android.baselib.util.AESImpl");
    // Java.choose("tj", {
    //     onMatch: function(instance) {
    //         // printFields(instance)
    //         // //console.log(instance.toString());
    //         // console.log(instance.iv.value)
    //         // console.log('------------------------')
...
//     //章节响应内容
//     let ChapterContentEntity = Java.use("com.qimao.qmreader.reader.model.entity.ChapterContentEntity");
// ChapterContentEntity["getContent"].implementation = function () {
//     console.log('getContent is called');
//     let ret = this.getContent();
//     console.log('getContent ret value is ' + ret);
//     return ret;
// };
// let se0 = Java.use("se0");//文件读取操作
// se0["d"].implementation = function (str, str2, str3) {
//     console.log('d is called' + ', ' + 'str: ' + str + ', ' + 'str2: ' + str2 + ', ' + 'str3: ' + str3);
//     showStacks()
//     let ret = this.d(str, str2, str3);
//     console.log('d ret value is ' + ret);
//     return ret;
// };

// let EncryptionUtil = Java.use("com.qimao.qmsdk.tools.encryption.EncryptionUtil");
// EncryptionUtil["replaceChar"].implementation = function (c) {
//     console.log('replaceChar is called' + ', ' + 'c: ' + c);
//     showStacks()
//     let ret = this.replaceChar(c);
//     console.log('replaceChar ret value is ' + ret);
//     return ret;
// };
//
let Security = Java.use("com.km.encryption.api.Security");
Security["decrypt"].implementation = function (str, str2) {
    console.log('decrypt1 is called' + ', ' + 'str: ' + str + ', ' + 'str2: ' + str2);
    let ret = this.decrypt(str, str2);
    console.log('decrypt1 ret value is ' + ret);
    return ret;
};
Security["decode"].implementation = function (str) {
    console.log('decode2 is called' + ', ' + 'str: ' + str);
    let ret = this.decode(str);
    console.log('decode2 ret value is ' + ret);
    return ret;
};
